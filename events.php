    	...
    	<div class="container" id="0">
            ...
            <div class="col-12 col-sm-6 col-md-6 col-lg-4 heading-section ftco-animate">
               ...
               <img class="card-img-top" src="images/hero.jpeg" alt="Card image cap">
                   <div class="card-body">
                   <h2 class="card-title">Birthday Events</h2>
